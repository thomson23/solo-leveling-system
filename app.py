...
# --- อัปเดตระบบตั้งค่ารายชื่อปาร์ตี้เริ่มต้นเป็น 8 คน ---
...
with st.sidebar:
    st.markdown("### 👥 PARTY SYSTEM (RAID GROUP)")
    ...
    # ฟีเจอร์แก้ไขชื่อผู้เล่นในปาร์ตี้ (รองรับ 8 ช่อง)
    with st.expander("📝 EDIT PLAYER NAMES (1-8)"):
        with st.form("edit_player_names_form"):
            ...
            if save_names_btn:
                ...
                st.toast("อัปเดตรายชื่อปาร์ตี้ 8 คนสำเร็จ! ⚔️")
                st.rerun()
